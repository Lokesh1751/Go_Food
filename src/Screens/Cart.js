        ...
        {showAlert ? (
          <div style={alertStyles}>
            <div class="payment-success">
              ...
              <p style={{marginTop:"15px",fontWeight:"bold",fontSize:"20px"}}>Order Placed Successfully!</p>
            </div>
          </div>
        ) : (
        ...
        <table className="table table-hover ">
          <thead className=" text-success fs-4">
            <tr>
              ...
              <th scope="col" style={{color:'#ed8936'}}>Name</th>
              <th scope="col" style={{color:'#ed8936'}}>Quantity</th>
              <th scope="col" style={{color:'#ed8936'}}>Option</th>
              <th scope="col" style={{color:'#ed8936'}}>Amount</th>
              <th scope="col" style={{color:'#ed8936'}}></th>
            </tr>
          </thead>
          <tbody>
